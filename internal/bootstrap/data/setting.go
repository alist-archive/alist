...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.Announcement, Value: "### repo\nhttps://codeberg.org/alist/alist", Type: conf.TypeText, Group: model.SITE},
		...
		// style settings
		{Key: conf.Logo, Value: "https://cdn.jsdelivr.net/gh/alist-archive/logo@main/logo.svg", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://cdn.jsdelivr.net/gh/alist-archive/logo@main/logo.svg", Type: conf.TypeString, Group: model.STYLE},
	...
	"epub": {
		...
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://cdn.jsdelivr.net/gh/alist-archive/logo@main/logo.svg", Type: conf.TypeString, Group: model.PREVIEW},
...
(?U)access_token=(.*)&`,
		...
		{Key: conf.OcrApi, Type: conf.TypeString, Group: model.GLOBAL, Help: "API endpoint for OCR service."},
