...
type Addition struct {
	...
	ClientID           string `json:"client_id" required:"true" help:"Your Aliyundrive Open API Client ID. This is required."`
	ClientSecret       string `json:"client_secret" required:"true" help:"Your Aliyundrive Open API Client Secret. This is required."`
